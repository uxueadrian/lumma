      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="bg-green-500 hover:bg-green-600 text-white px-8 py-3.5 rounded-xl text-base font-semibold transition-all shadow-lg shadow-green-200 hover:shadow-xl hover:-translate-y-0.5 inline-flex items-center gap-2"
          >
